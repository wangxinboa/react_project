			...
			<div className='code_files_tree'>
				{
					Array.isArray(codeFiles) && codeFiles.length > 0 ?
						<Tree
							...
							defaultExpandedKeys={['reproduction/', 'reproduction/libs/', 'reproduction/libs/parse-svg-path/', 'reproduction/src/', 'reproduction/src/_virtual/', 'reproduction/src/accessibility/', 'reproduction/src/scene/', 'reproduction/src/scene/sprite/', 'reproduction/src/scene/view/', 'reproduction/src/rendering/', 'reproduction/src/rendering/renderers/', 'reproduction/src/assets/']}
							onSelect={onSelect}
							onExpand={onExpand}
							fieldNames={{
								title: 'name',
